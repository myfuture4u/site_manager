...
- **Cấu hình Master Data**: Dành riêng cho User có quyền `Admin`, hệ thống cho phép người quản trị tự định nghĩa Dữ liệu chuẩn cho toàn hệ thống: Danh sách Tỉnh/Thành phố, Phường, Loại hình và Trạng thái mặt bằng. Truy cập qua thanh Menu bên trái (Sidebar).
